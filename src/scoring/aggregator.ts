  ...
  const contributions: ScoreContributor[] = [
    {
      ...
      examples: vocabularyResult.examples,
    },
    {
      ...
      subcategories: structuralResult.subcategories.map((s) => ({ ...s })),
      examples: structuralResult.examples,
    },
    {
      ...
      subcategories: vagueResult.subcategories.map((s) => ({ ...s })),
      examples: vagueResult.examples,
    },
    {
      ...
      subcategories: promotionalResult.subcategories.map((s) => ({ ...s })),
      examples: promotionalResult.examples,
    },
    {
